...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rb-addressable-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7598&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rb-addressable-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rb-addressable` can be installed with:

```
conda install rb-addressable
```

It is possible to list all of the versions of `rb-addressable` available on your platform with:
